...
class Assessment extends Component {
  ...
  ClickSubmitBtn = () => {
    ...
    const {setElapsedTimeInSeconds} = this.context
    this.setState({
      isTimeRunning: false,
    })
    ...
    history.replace('/results', {score, isTimeRunning})
  }
  ...
  renderQuestions = () => {
    ...
    return (
      <DetailsContext.Consumer>
        {value => {
          const {elapsedTimeInSeconds} = value
                  ...
                  <div className="questions-Container">
                    <div className="space-between-btn-questions">
                      <h1 className="question">
                        {currentQuestion + 1}.
                        {displayingOneQuestion.questionsText}
                      </h1>
